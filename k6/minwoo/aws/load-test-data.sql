-- ============================================
-- 부하 테스트용 데이터 생성 SQL (AWS 환경)
-- 테스트 유저 50만명 + 선착순 이벤트 1개 (100명 모집)
-- ============================================

-- 1. 테스트 유저 50만명 생성 (비밀번호: test1234)
...
BEGIN
    ...
    WHILE i <= 500000 DO
        ...
        VALUES (
            ...
            CONCAT('010', LPAD(i % 100000000, 8, '0')),
            '2000-01-01',
            'READER',
            false,
            false,
...
-- 3. 확인
SELECT id, title, max_participants FROM events WHERE title LIKE '%부하테스트%';
